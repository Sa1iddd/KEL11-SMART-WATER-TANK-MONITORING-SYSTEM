...
#WIFI_SSID = "iee inggomiu"  # Ganti dengan nama WiFi Anda
WIFI_SSID = "hoshimachi"
#WIFI_PASSWORD = "apayangberkilau"  # Ganti dengan kata sandi WiFi Anda
WIFI_PASSWORD = "satuduatiga123"
# SERVER_URL harus menunjuk ke direktori /api di server Anda
SERVER_URL = "https://iot-watertank.kzn.my.id/api"
API_KEY = "iamesp32"  # Ganti dengan API Key Anda
...
LOCAL_AUTO_ON_THRESHOLD_PERCENT = 0.30   # Contoh: Nyala pada 20%
...
USE_ENCRYPTED_MODE = False  # Ubah ke True untuk mode terenkripsi
...
def main():
    ...
    global send_data_flag, check_status_flag, ENCRYPTION_ALGORITHM
